...
import net.mcreator.thedirtystuff.procedures.CocaineRightclickedProcedure;
...
public class CocaineItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		CocaineRightclickedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
}
