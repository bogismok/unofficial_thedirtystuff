...
public class TheDirtyStuffMod {
	...
	public TheDirtyStuffMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		TheDirtyStuffModBlocks.REGISTRY.register(bus);
		TheDirtyStuffModBlockEntities.REGISTRY.register(bus);
		TheDirtyStuffModItems.REGISTRY.register(bus);

		TheDirtyStuffModTabs.REGISTRY.register(bus);

		TheDirtyStuffModMenus.REGISTRY.register(bus);
