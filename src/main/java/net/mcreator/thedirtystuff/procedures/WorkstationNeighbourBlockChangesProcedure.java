...
public class WorkstationNeighbourBlockChangesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (!world.isEmptyBlock(new BlockPos(x, y + 1, z))) {
			...
			world.setBlock(new BlockPos(x, y, z), TheDirtyStuffModBlocks.WORKSTATION.get().defaultBlockState(), 3);
			{
				Direction _dir = facing;
