package net.mcreator.thedirtystuff.world.inventory;
...
public class WorkstationGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WorkstationGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheDirtyStuffModMenus.WORKSTATION_GUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 98, 39) {
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 125, 39) {
